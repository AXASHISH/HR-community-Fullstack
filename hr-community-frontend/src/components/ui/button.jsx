  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        teal: "bg-teal text-teal-foreground hover:bg-teal/90 shadow-soft hover:shadow-card",
        success:
          "bg-success text-success-foreground hover:bg-success/90 shadow-soft",
        hero:
          "gradient-primary text-primary-foreground hover:opacity-90 shadow-elevated text-base px-8 py-3 rounded-lg font-semibold",
      },
      size: {
...
// Optional JSDoc for IntelliSense
/**
 * @param {{
 *  className?: string,
 *  variant?: string,
